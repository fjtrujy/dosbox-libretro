...
#if defined(WIN32) || (defined(__LIBRETRO__) && (defined(GEKKO) || defined(PS2) || defined(PSP) || defined(VITA) || defined(_3DS) || defined(__SWITCH__))) // __LIBRETRO__: No dirname on wii
